...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8491456735:AAHPhWUD36bPuhe07IxOK82-jiNfjzXNx1A")
...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://yumeckoweilai:weilai@cluster0.vpc5wfx.mongodb.net/")
DB_NAME = os.environ.get("DATABASE_NAME", "yumeckoweilai")
#--------------------------------------------
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://graph.org/file/8ead32d60231054405735-e1b5c2eb8d9ca9362c.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://graph.org/file/7877b6fccebbc9bf1b278-c03f9bee1cf328e46b.jpg")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @Anime_Ryzen</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
...
UPI_ID = os.environ.get("UPI_ID", "<a href=https://t.me/Adult_Eternals/8>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></blockquote></b>")
